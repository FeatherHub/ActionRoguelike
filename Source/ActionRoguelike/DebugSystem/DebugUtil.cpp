...
static TAutoConsoleVariable<bool> CVarDebugShowNetContext{TEXT("rogue.debug.onscreen.ShowNetContext"), false,
	TEXT("Show net context for on-screen debug message. 1=Show, 0=Hide"), ECVF_Default};

static TAutoConsoleVariable<bool> CVarDebugToggleAll{TEXT("rogue.debug.onscreen.ToggleAll"), false,
    TEXT("Toggle all on-screen debug message. 1=ON, 0=OFF"), ECVF_Default};

static TAutoConsoleVariable<int32> CVarDebugPIEFilter{TEXT("rogue.debug.onscreen.PIEFilter"), -1,
    TEXT("Show messages from specific PIE Instance only. -1=Show All PIE Instances, or PIE ID"), ECVF_Default};

static TAutoConsoleVariable<int32> CVarDebugNetFilter{TEXT("rogue.debug.onscreen.NetModeFilter"), 0,
	TEXT("Show messages from specific NetMode Instance only. 0=Client and Server, 1=Client Only, 2=Server Only"), ECVF_Default};
